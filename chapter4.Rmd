...
This plot is difficult to read eventhough I scale the output to 100 % and set dpi=300. I'll figure out later how to improve the quality of the output. From the summary table I'm however able to explore the variation and distributions of the variables. 
...
Next I cluster the data into groups. I run k-means algorithm on the dataset, investigate what is the optimal number of clusters and run the algorithm again. 
...
Now the clustering seems better, at least for some variable pairs. 